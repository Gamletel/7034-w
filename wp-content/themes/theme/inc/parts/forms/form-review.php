<div class="form form-v2 form-review">
    ...
    <div class="form__inputs">
        ...
        <textarea name="your-question" class="input" placeholder="Текст отзыва*" required></textarea>
    </div>

    <button class="form__btn btn" type="submit" form-send>
        Отправить
    </button>

    <div class="p3 form__policy">
