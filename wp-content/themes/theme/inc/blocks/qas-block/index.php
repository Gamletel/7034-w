...
class QASBlock
{
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/qas-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/qas-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
