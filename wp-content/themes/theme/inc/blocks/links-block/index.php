...
class LinksBlock
{
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/links-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/links-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
