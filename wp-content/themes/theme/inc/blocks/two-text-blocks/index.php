...
class TwoTextBlocks
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				...
				'title'             => 'Блок: 2 блока с текстом',
				'description'       => '2 блока с текстом',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/two-text-blocks',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/two-text-blocks',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
