...
class ServicesBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'services-block',
				'title'             => 'Блок: Услуги',
				'description'       => 'Слайдер с услугами',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/services-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/services-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
